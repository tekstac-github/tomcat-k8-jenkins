    ...
    stages {
        ...
        stage('Create Docker Registry Secret') {
            steps {
                script {
                        sh """
                        echo "jenkins" | sudo -S -u student kubectl create secret docker-registry docker-registry-secret \
        ...
        stage('Deploy on K8') {
            steps {
                sh 'echo "jenkins" | sudo -S -u student kubectl apply -f deployment.yaml'
